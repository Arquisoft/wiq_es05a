...
The deployment url is: [https://arquisoft.github.io/wiq_es05a/](https://arquisoft.github.io/wiq_es05a/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wiq_es05a/](https://arquisoft.github.io/wiq_es05a/), we need to execute `npm run deploy`.
